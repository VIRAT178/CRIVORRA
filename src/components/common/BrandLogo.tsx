...
export const BrandLogo: React.FC<BrandLogoProps> = ({
  ...
  return (
    <div className={`inline-flex flex-col select-none ${className ? className : 'items-start'}`}>
      ...
      {showTagline && (
        <span
          className={`font-mono-code tracking-widest uppercase font-semibold mt-1.5 ${taglineSizeClasses} text-center ${

...
import { GrowthPipelineSection } from './components/sections/GrowthPipelineSection';
      ...
      <main className="flex-1">
        {currentPage === 'about-crivorra' ? (
          ...
          <>
            ...
            {/* Ultra-Premium 3D Growth Pipeline (Our Approach: From Visibility to Growth) */}
            <GrowthPipelineSection onOpenProjectPlanner={() => setIsProjectPlannerOpen(true)} />
